...
use Kemistra\MainBundle\Entity\Ville;
use Kemistra\MainBundle\Form\VilleType;
...
class VilleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KemistraMainBundle:Ville')->findAll();

        return $this->render('KemistraMainBundle:Ville:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KemistraMainBundle:Ville:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KemistraMainBundle:Ville')->find($id);
        ...
        return $this->render('KemistraMainBundle:Ville:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KemistraMainBundle:Ville:edit.html.twig', array(
            'entity'      => $entity,
